...
User::User(const string &name, int regNo) : Person(name), name(name), regNo(regNo), accumulative_reputation_score(0), average_reputation_score(0), numOfModeratedPosts(0) {}
